...
def generate_thumbnail_hf(prompt: str, video_path: str, progress_callback=None) -> str:
    """
    Extracts a high-quality frame from the video as the server-side thumbnail.
    The primary AI thumbnail is generated by Puter.js (Nano Banana) in the browser.
    This is the reliable fallback when the frontend AI generation fails.
    """
    log_progress(progress_callback, "log", message="Extracting clean thumbnail from video frame (server fallback)...")
